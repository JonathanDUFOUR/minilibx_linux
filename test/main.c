...
int	expose_win1(void *p)
{
	...
	xyc[0] = 0;
	xyc[1] = 0;
	mlx_put_image_to_window(mlx, win1, im3, xyc);
}
...
int	expose_win2(void *p)
{
	...
	xyc[0] = 0;
	xyc[1] = 0;
	mlx_put_image_to_window(mlx, win2, im4, xyc);
	mlx_put_image_to_window(mlx, win2, im2, xyc);
}
...
int	main(void)
{
	...
	xyc[0] = 20;
	xyc[1] = 20;
	mlx_put_image_to_window(mlx, win1, im1, xyc);
	printf("OK\n");
	sleep(2);
	...
	printf("OK (bpp3 %d, sizeline3 %d endian3 %d type %d)\n",
		bpp3, sl3, endian3, ((t_img *)im3)->type);
	...
	xyc[1] = WIN1_SY / 2;
	xyc[2] = 0xFF99FF;
	mlx_string_put(mlx, win1, xyc, "String output");
	xyc[0] = 15;
	xyc[1] = WIN1_SY / 2 + 20;
	xyc[2] = 0x00FFFF;
	mlx_string_put(mlx, win1, xyc, "MinilibX test");
	printf("OK\n");
	sleep(2);
	...
	xyc[0] = 0;
	xyc[1] = 0;
	mlx_put_image_to_window(mlx, win1, im2, xyc);
	xyc[0] = 100;
	xyc[1] = 100;
	mlx_put_image_to_window(mlx, win1, im2, xyc);
	printf("OK\n");
